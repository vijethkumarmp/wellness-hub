...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-primary text-primary-foreground selection:bg-accentmintgreen selection:text-primary overflow-clip">
      ...
      {/* 
        SECTION 1: HERO 
        Directly inspired by HPI 1.7-V layout structure.
        Asymmetrical split, bold color blocking, geometric grid motif, top-right accent.
      */}
      <section ref={heroRef} className="relative w-full min-h-[100svh] flex flex-col lg:flex-row pt-20 lg:pt-0">
        
        {/* Left Column - Vibrant Blue Block */}
        <motion.div 
          style={{ y: heroY, opacity: heroOpacity }}
          className="w-full lg:w-[55%] bg-secondary flex flex-col justify-center px-6 py-20 lg:px-20 xl:px-32 relative z-10"
        >
          <motion.div variants={staggerContainer} initial="hidden" animate="visible" className="max-w-3xl">
            ...
            <motion.div variants={fadeUp} className="flex flex-col sm:flex-row gap-6">
              <Link 
                to="/dashboard"
                className="group relative inline-flex items-center justify-center bg-accentmintgreen text-primary font-heading text-lg uppercase px-10 py-5 overflow-hidden"
              >
              ...
              <Link 
                to="/articles"
                className="inline-flex items-center justify-center border border-primary-foreground/30 text-primary-foreground font-heading text-lg uppercase px-10 py-5 hover:bg-primary-foreground hover:text-secondary transition-colors duration-300"
              >
                Explore Articles
              </Link>
            </motion.div>
        ...
        <div className="w-full lg:w-[45%] bg-primary relative min-h-[50vh] lg:min-h-screen flex items-center justify-center overflow-hidden">
          <GeometricGrid className="text-accentmintgreen" />
          
          {/* Top Right Accent Block (from inspiration) */}
          <div className="absolute top-0 right-0 bg-accentmintgreen text-primary px-8 py-4 hidden lg:block z-20">
          ...
          >
            <div className="absolute inset-0 border border-accentmintgreen/30 rounded-full animate-[spin_60s_linear_infinite]" />
            <div className="absolute inset-4 border border-secondary/40 rounded-full animate-[spin_40s_linear_infinite_reverse]" />
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="w-32 h-32 bg-secondary/20 backdrop-blur-xl rounded-full flex items-center justify-center border border-secondary/50">
      ...
      {/* 
        ...
        A moment of cinematic pause to establish the core philosophy.
      */}
      <section ref={breatherRef} className="relative w-full h-[80vh] lg:h-[100vh] overflow-hidden flex items-center justify-center">
        ...
        <div className="relative z-10 text-center px-6 max-w-5xl mx-auto">
          <motion.div
            ...
            variants={fadeUp}
          >
            <div className="inline-block border border-accentmintgreen/50 px-6 py-2 mb-8 rounded-full backdrop-blur-sm">
              <span className="font-heading text-accentmintgreen uppercase tracking-widest text-sm">The Philosophy</span>
            </div>
            <h2 className="font-heading text-4xl md:text-6xl lg:text-7xl uppercase leading-tight mb-6">
              ...
              <span className="text-secondary">get sick.</span>
            </h2>
            <p className="font-paragraph text-xl md:text-2xl text-primary-foreground/70 max-w-2xl mx-auto">
      ...
      {/* 
        ...
        Dynamic sticky layout to create narrative flow rather than a static grid.
      */}
            ...
            <div className="lg:col-span-5">
              <div className="sticky top-32">
                ...
                >
                  ...
                  <p className="font-paragraph text-lg text-primary-foreground/70 mb-8 max-w-md">
                  ...
                  <div className="w-24 h-1 bg-accentmintgreen" />
                </motion.div>
              </div>
            </div>
            ...
            <div className="lg:col-span-7 flex flex-col gap-6 lg:gap-8">
              {features.map((feature, index) => (
                <motion.div
                  ...
                  className="group bg-secondary/5 border border-secondary/20 p-8 lg:p-12 hover:bg-secondary/10 transition-colors duration-500 relative overflow-hidden"
                >
                  ...
                  <div className="relative z-10 flex flex-col sm:flex-row gap-8 items-start">
                    <div className="p-4 bg-primary border border-secondary/30 rounded-xl shrink-0 group-hover:border-accentmintgreen transition-colors duration-300">
      ...
      {/* 
        ...
        Magazine-style split layout with large imagery and stepped narrative.
      */}
        ...
        <div className="max-w-[120rem] mx-auto px-6 lg:px-12 relative z-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            ...
            <div className="space-y-16 lg:space-y-24 relative">
              {/* Connecting Line */}
              <div className="absolute left-[1.15rem] top-4 bottom-4 w-px bg-primary-foreground/20 hidden sm:block" />
              ...
              {[
                ...
                >
                  <div className="hidden sm:flex absolute left-0 top-1 w-10 h-10 rounded-full bg-primary items-center justify-center border-2 border-accentmintgreen z-10">
                    <span className="font-heading text-sm text-accentmintgreen">{item.step}</span>
                  </div>
                  <h3 className="font-heading text-2xl lg:text-4xl uppercase mb-4 text-accentmintgreen">
            ...
            <motion.div
              ...
              className="relative h-[60vh] lg:h-[80vh] w-full rounded-3xl overflow-hidden border border-primary-foreground/20"
            >
              <Image 
                src={PLACEHOLDER_IMG} 
              ...
              {/* Overlay UI Element */}
              <div className="absolute bottom-8 left-8 right-8 bg-primary/80 backdrop-blur-md border border-primary-foreground/20 p-6 rounded-xl">
                <div className="flex items-center justify-between mb-4">
                  <span className="font-heading uppercase text-accentmintgreen">System Status</span>
                ...
                <div className="h-2 bg-secondary/30 rounded-full overflow-hidden">
                  <motion.div 
                    ...
                    className="h-full bg-accentmintgreen"
                  />
                </div>
              </div>
            </motion.div>
      ...
      {/* 
        ...
        Full-width image banner with overlapping content block.
      */}
      <section className="w-full bg-primary py-24 lg:py-40 relative">
        <div className="max-w-[120rem] mx-auto px-6 lg:px-12">
          <div className="relative w-full min-h-[70vh] flex items-center">
            ...
            <motion.div 
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.8 }}
              className="relative z-10 w-full lg:w-1/2 bg-primary/90 backdrop-blur-xl border border-secondary/30 p-8 lg:p-16"
            >
              <div className="inline-flex items-center justify-center w-20 h-20 border-2 border-accentmintgreen rounded-full mb-8">
                <span className="font-heading text-3xl text-accentmintgreen">VI</span>
              </div>
              <h2 className="font-heading text-4xl lg:text-6xl uppercase mb-6">
                The Vitality <br />
                <span className="text-secondary">Index</span>
              </h2>
              <p className="font-paragraph text-lg lg:text-xl text-primary-foreground/80 mb-8 leading-relaxed">
              ...
              <ul className="space-y-4 mb-10">
                {['Mental State Correlation', 'Biometric Anomaly Detection', 'Lifestyle Impact Scoring'].map((item, i) => (
                  <li key={i} className="flex items-center gap-3 font-heading uppercase text-sm tracking-wider">
                    <div className="w-1.5 h-1.5 bg-accentmintgreen rounded-full" />
                    {item}
                  </li>
                ))}
              </ul>
              <Link 
                to="/dashboard"
                className="inline-flex items-center gap-2 text-accentmintgreen font-heading uppercase hover:text-primary-foreground transition-colors"
              >
      ...
      {/* 
        SECTION 6: CTA
        Bold, high-contrast closing statement.
      */}
      <section className="w-full bg-accentmintgreen py-32 lg:py-48 relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto px-6 text-center relative z-10">
          ...
          >
            ...
            <p className="font-paragraph text-xl text-primary/80 mb-12 max-w-2xl mx-auto">
              Join thousands who are taking control of their wellbeing with proactive, AI-powered health intelligence.
            </p>
            <Link 
              to="/dashboard"
              className="inline-block bg-primary text-accentmintgreen font-heading text-xl uppercase px-12 py-6 hover:bg-secondary hover:text-primary-foreground transition-colors duration-300"
            >
              Get Started Now
            </Link>
          </motion.div>
